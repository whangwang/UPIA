  ...
  >
    ...
    <div className="absolute inset-0">
      <img 
        src={image} 
        alt={title} 
        className="w-full h-full object-cover opacity-40 group-hover:opacity-60 group-hover:scale-105 transition-all duration-700 ease-out grayscale group-hover:grayscale-0 mix-blend-overlay"
      />
      {/* Gradient Overlay for Text Readability */}
      <div className="absolute inset-0 bg-gradient-to-t from-navy-950 via-navy-900/80 to-navy-900/20 group-hover:via-navy-900/60 transition-all duration-500"></div>
    </div>
        ...
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
             <motion.div 
               ...
               className="bg-navy-900 border border-white/10 p-12 relative overflow-hidden"
             >
                <div className="absolute top-0 right-0 w-64 h-64 bg-pacific-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                ...
                <div className="space-y-6">
                    <button className="w-full py-6 bg-pacific-600 hover:bg-pacific-500 text-white font-bold text-lg uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(0,102,255,0.3)] hover:shadow-[0_0_30px_rgba(0,102,255,0.5)] flex items-center justify-center gap-3 group">
                        Apply Now
                        <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                    </button>
                    <p className="text-center text-xs text-slate-500 font-mono uppercase">
                        Current Cohort: Q3 2025 Open
                    </p>
                </div>

                {/* Decorative Visual Element */}
                <div className="mt-12 flex items-center justify-between border-t border-white/5 pt-6 opacity-60">
                    <div className="flex gap-2">
                        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                        <span className="text-xs font-mono text-slate-400">NETWORK ACTIVE</span>
                    </div>
